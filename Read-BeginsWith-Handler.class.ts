...
export abstract class ReadBeginsWithHandler extends LambdaHandler {
    ...
    protected performActions() {
      this.db.query(this.makeBeginsWithSyntax()).promise()
        ...
        private makeBeginsWithSyntax() {
          return {
            ...
            KeyConditionExpression: '#p = :x AND begins_with(#i, :v)',
